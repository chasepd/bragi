    ...
    return "\n".join(
        ...
        for part in (
            ...
            (
                ...
                "should keep pursuing goals and may interrupt, demand, refuse, "
                "leave, escalate, advance consequences, reveal visible "
                "changes, or create pressure when consistent with established "
                "context, and such reactions are never player-agency "
                "violations. For example, if the player character hugs Jane, "
