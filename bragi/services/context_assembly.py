    ...
    return "\n".join(
        ...
        for part in (
            ...
            (
                ...
                "committed to in a submitted message (for example, a "
                "submitted knock lands and the door can be answered) so the "
                "world can react, but must not invent or advance uncommitted "
                "player actions such as texting, sleeping, traveling, "
                "arriving, or carrying out a plan. Stated intent, "
