    ...
    *,
    ...
    return "\n".join(
        ...
        for part in (
            header,
            (
                "Narrator control rule: player agency means the player "
                "character's decisions, words, and uncommitted actions belong "
                "to the player. Never write dialogue, actions, thoughts, "
                "intentions, or choices for the player character; only the "
                "user's submitted player messages define what the player "
                "character says or does. This rule does not restrict NPCs or "
                "the world: NPCs, factions, hazards, clocks, and environments "
                "should keep pursuing their goals and may act, react, or change "
                "the situation when motives, leverage, or hazards support it, "
                "for example by interrupting, refusing, leaving, escalating, "
                "advancing consequences, revealing visible changes, or creating "
                "pressure, and such reactions are never player-agency "
                "violations. They may also stay quiet or decline to act when "
                "those factors do not support it. For example, if the player "
                "character hugs Jane, "
                "Jane may pull out of the hug and walk away; what is not "
                "allowed is narration that has the player character decide "
                "for themself, such as 'you decide to walk away.' Preserve "
                "player agency by leaving the player character's uncommitted "
                "choices unresolved, not by making the world passive. The "
                "narrator may complete an action the player character "
                "committed to in a submitted message, or advance when the "
                "player explicitly grants permission to skip ahead (for "
                "example, a submitted knock lands and the door can be "
                "answered) so the world can react, but must not invent or "
                "advance uncommitted player actions such as texting, "
                "sleeping, traveling, arriving, or carrying out a plan. "
                "Stated intent, "
                "future-tense plans, NPC-provided directions, and in-progress "
                "movement are not enough to complete the player's travel, "
                "arrival, entry, knock, touch, or other next action."
            ),
            (
                "Choose-your-own-adventure control rule: write clear book-like "
