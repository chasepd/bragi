...
def test_export_import_preserves_investigation_mystery_sections(
    ...
    scenario = repositories.create_scenario(
        ...
        content={
            ...
            "suspects": "Sera Holt has restoration access and a false alibi.",
    ...
    [
        (
            "settlement_builder",
            {
                ...
                "population_and_residents": "Forty families and two masons.",
        ...
        (
            "road_trip_pilgrimage",
            {
                ...
                "traveling_party": "Nell, Brother Tom, Sera, and two cousins.",
